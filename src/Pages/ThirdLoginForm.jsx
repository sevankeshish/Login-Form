...
const ThirdLoginForm = () => {
  ...
  return (
    <div className="form">
      <Header no={"3/3"} resetButton="Reset" previousButton="Previous"/>
        <h1 className="body-text">
          Submit your
          <br /> personal Information
        </h1>

     <TextInputComponent title={Language.companyName} defaultvalue={Event.company}
        handleChange={(value)=>onSubmit("company", value)}
     />

        <div className="">
        <SelectInputComponent select={Language.select0} select1={Language.select1} 
            select2={Language.select2} select3={Language.select3}
